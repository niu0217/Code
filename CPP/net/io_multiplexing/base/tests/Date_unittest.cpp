/* ************************************************************************
> File Name:     Date_unittest.cpp
> Author:        niu0217
> Created Time:  Thu 20 Jun 2024 01:32:30 PM CST
> Description:   
 ************************************************************************/
...
int main()
{
  ...
  struct tm t1 = *gmtime(&now); // 将now转换为世界标准时间（UTC）放到t1
  struct tm t2 = *localtime(&now); //将now转换为本地时间（当前系统设置的本地时区时间）放到t2
